...
function App() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center radialBg">
    <NavBar/>
...
function CardPost({postTitle, postTag}){
  return (
    <button className="bg-neutral-900 w-60 border border-stone-500 rounded-md text-stone-300 text-left hover:bg-neutral-800 transition-all overflow-hidden">
...
function SearchBarComponent(){
  return (
    <div className='flex w-4/5 md:w-2/5 flex-initial mb-12 bg-stone-900 rounded-full pl-4 border border-stone-500'>
